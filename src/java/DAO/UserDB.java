...
//        }
    ...
    public static JsonArray ConvertListUsersToJsonArray(List<User> users) {
        ...
        users.forEach(user -> {
            ...
            formDetailsJson.addProperty("Name", user.getName());
            formDetailsJson.addProperty("DateOfBirth", user.getDateOfBirth().toString());
            formDetailsJson.addProperty("Gender", user.isGender());
            formDetailsJson.addProperty("Email", user.getEmail());
            formDetailsJson.addProperty("Phone", user.getPhone());
            formDetailsJson.addProperty("RoleName", user.getRole().getRoleName());
