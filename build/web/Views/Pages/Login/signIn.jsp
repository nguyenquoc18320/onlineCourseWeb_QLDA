                ...
                <div class="small-container">
                    ...
                    <div class="text-input-login">
                        ...
                        <div class="text-input">
                            ...
                            <input type="email" id="txtEmail" name="email" placeholder="Email của bạn" value="<c:out value="${varEmail}"/>" required/>
                        </div>
                    </div>
                    <div class="text-input-login">
                        <div class="label-input">
                        ...
                        <div class="text-input">
                            <input type="password" id="txtPassword" name="password" <c:out value="${Password}"/> placeholder="Mật khẩu của bạn" required/>
                        </div>
                    </div>
